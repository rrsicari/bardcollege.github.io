...
var rules = {
  ...
  "~*x sorry ~*y": [
    "You should be sorry",
    "You will never understand the pain I have endured",
    "Sorry isn't going to cut it this time.",
  ],
  "~*x I remember ~*y": [
    "I really don't care about ~y?",
    "Don't you have something else to do?",
    "No one cares what you remember",
    "Please stop asking about ~y right now?",
  ...
  "~*x I want ~*y": [
    ...
    "~*x I need ~*y": [
    "I really don't care that you need ~y",
    "Why do you need ~y? Actually, nevermind. I don't want to know",
    "I have ~y but you can't have it.",
  ],
  "~*x if ~*y": [
